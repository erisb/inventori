...
class MasterRuangan extends Component {
    ...
    componentDidMount(){
        this.setState({
            header:[
                {
                    title: 'Nama Ruangan', field: 'nama_ruangan',
                    headerStyle: {
                      backgroundColor: '#5a8dee',
                    }
                },
                {
                    title: 'Detil Ruangan', field: 'detil_ruangan',
                    headerStyle: {
                      backgroundColor: '#5a8dee',
                    }
                },
    ...
    handleSaveData = async (data1,data2,data3) => {
        try {
            ...
            let res = await axios.post(process.env.NEXT_PUBLIC_API_URL + "masterRuangan",params,{
                headers:{
                    "Authorization":"Bearer "+token,
                    "content-type":"application/json"
                },
    ...
    handleEditData = async (id,data1,data2,data3) => {
        try {
            ...
            let res = await axios.put(process.env.NEXT_PUBLIC_API_URL + "masterRuangan/" + id,params,{
                headers:{
                    "Authorization":"Bearer "+token,
                    "content-type":"application/json"
                },
    ...
    handleDeleteData = async (id) => {
        try {
            let token = this.state.statusTokenBaru === false ? this.props.auth.token : this.state.tokenBaru;
            let res = await axios.delete(process.env.NEXT_PUBLIC_API_URL + "masterRuangan/" +id,{
                headers:{
                    "Authorization":"Bearer "+token
                },
                crossdomain: true
                    ...
                    <div id="app">
                        ...
                        <div id="main">
                            ...
                            <div className="main-content container-fluid">
                                        ...
                                        <div className="col-12 col-md-6 order-md-2 order-first">
                                            <nav aria-label="breadcrumb" className='breadcrumb-header'>
                                                <ol className="breadcrumb">
                                                    ...
                                                    <li className="breadcrumb-item active" aria-current="page">Master Ruangan</li>
                                                </ol>
                                            </nav>
                                        </div>
                                    </div>
                                ...
                                <Table
                                    menu="master_ruangan"
                                    textButton="Tambah Ruangan"
                                    textHeaderModalEdit="Edit Ruangan"
...
export default connect(mapStateToProps, mapDispatchToProps)(MasterRuangan)